struct PoolDir{
    ...
    storage_read_start: u32,
    storage_read_skip: u32,
}

@group(0) @binding(0) var<storage, read> pool_idx_storage_buffer: array<u32>;
...
fn main(@builtin(global_invocation_id) gid: vec3<u32>) {
    ...
    let storage_batch_offset = pool_dir.storage_read_skip * batch_i;

...
impl ModelConstructor {
    ...
    pub fn add_conv_layer(&mut self, kernal_size: usize, pool_size: usize, n_kernals: usize) {
...
impl BasicNNModel {
    pub fn construct(constructor: &ModelConstructor) -> Self {
        ...
        let nn_dispatch = NNDispatch::new(&gpu_instance, &nn_constructor, &data_constructor);

        return BasicNNModel {
            nn_info: NeuralNetworkInfo::new(
                &constructor.nn_dim,
                constructor.n_batches as usize,
                constructor.lr,
                constructor.mr,
            ),
